import {
  ...
  const Navbar2 = () => {
    ...
    return (
      <NavigationMenu 
        className={`border-none shadow-none bg-custom-radial-gradient z-50 fixed font-montserrat flex items-center justify-between p-4 px-16 text-white w-full bg-black transition-all duration-1000 ease-in-out`}
      >
        {/* Logo */}
